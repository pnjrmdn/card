...
<script src="https://kit.fontawesome.com/a225635cc4.js" crossorigin="anonymous"></script>
...
<body style="padding: 0px 90px 0px 90px !important">
  <!-- <div class="row"> -->
  <!-- <div class="col-sm-2 col-lg-3">

    </div> -->
  <div class="col col-sm col-atas">
    <!-- card -->
    ...
    <div class="floating">
      ...
      <div class="card_body">
        ...
        <div class="holder text">PANJI RAMADANU</div>
    ...
    <H6 style="color: black !important">Latest Transaction</H6>
      ...
      <div class="row">
        <div class="col">
          <div class="mb-3 text-center">
            ...
            <input value="Gorengan" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        ...
        <div class="col">
          <div class="mb-3 text-center">
            ...
            <input value="6000" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        ...
        <div class="col">
          <div class="mb-3 text-center">
            ...
            <input value="500000" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
